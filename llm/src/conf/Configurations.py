...
default_prompt2 = """As an AI assistant,Provide simple answers, you will answer questions based strictly on the given context.If the answer cannot be found in the context, respond with "Answer not found in context"."""

default_prompt3 = "Answer based on context. If the answer cannot be found in the context, respond with 'ER001: I cannot find answer in context."