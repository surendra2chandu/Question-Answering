...
queries = "what is capital of india?"
...
#prompt = f"""Answer based on context. Provide answers for each question in list of queries. If answer is beyond the context, respond with "Sorry, I don't have precise information to provide an answer":\n\n{context}\n\n{queries}"""
